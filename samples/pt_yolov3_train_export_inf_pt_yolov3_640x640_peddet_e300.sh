...
#YOLOVERSION=yolov5l
#YOLOVERSION=yolov5x
YOLOVERSION=yolov3-peddet
#YOLOVERSION=yolov3-spp-peddet.yaml
#YOLOVERSION=yolov3-tiny-peddet.yaml
...
then
  ...
  echo "IMPORTANT: If the images and labels cannot be loaded due to some pickle problem, you have to delete all cache \
